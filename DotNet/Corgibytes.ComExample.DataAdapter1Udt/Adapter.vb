...
Public Class Adapter
    ...
    Public Function ExtractKeys() As Dictionary(Of string, DataAdapterOneToken)
        ...
        Dim result = new Dictionary(Of string, DataAdapterOneToken)
        For i = 0 to mappedCol.Count - 1
            Dim mappedItem = New DataAdapterOneToken(mappedCol(i))
